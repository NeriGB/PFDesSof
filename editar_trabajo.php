<?php
    ...
    $editar = "SELECT * FROM Trabajo WHERE IdTrabajo = '$id'";
    ...
    <div class="container">
        <div class="card border-5 border-dark m-5">
            <div class="card-header text-center">
                <h1 class="card-title">EDITAR TRABAJO</h1>
            </div>
                    <div class="card-body">
                            <form action="./editarT.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $row["IdTrabajo"]; ?>">
                                <div class="input-group p-2">
                                    <span class="input-group-text p-2">Nombre : </span>
                                    <input name="NombreTrabajo" type="text" class="form-control" value="<?php echo $row["NombreTrabajo"]; ?>">
                                </div>
                                <div class="input-group p-2">
                                    <span class="input-group-text p-2">Descripcion : </span>
                                    <input name="Descripcion" type="text" class="form-control" value="<?php echo $row["Descripcion"]; ?>">
                                </div>
                                <div class=" input-group p-2">
                                ...
                                <div class="container p-2 top-100 start-100">
                                    <a class="btn btn-dark btn-lg" href="mostrar_trabajos.php">ATRAS</a>
